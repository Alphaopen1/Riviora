...
const metaByLocale: Record<Locale, { title: string; description: string; ogLocale: string }> = {
  ...
  en: {
    ...
    description:
      "Riviora: private chauffeur and premium excursions on the French Riviera. Monaco, Saint-Tropez, Cannes, Nice. Airport transfers, day tours, custom itineraries. 24/7 bookings.",
    ogLocale: "en_GB",
  },
  de: {
    title: "Riviora | Privatfahrer & Ausflüge an der Côte d'Azur",
    description:
      "Riviora: Privatfahrer und Premium-Ausflüge an der Côte d'Azur. Monaco, Saint-Tropez, Cannes, Nizza. Flughafentransfers, Tagestouren, individuelle Routen. Buchung 24/7.",
    ogLocale: "de_DE",
  },
  es: {
    title: "Riviora | Conductor Privado & Excursiones en la Costa Azul",
    description:
      "Riviora: chófer privado y excursiones premium en la Costa Azul. Mónaco, Saint-Tropez, Cannes, Niza. Traslados al aeropuerto, visitas guiadas, itinerarios a medida. Reservas 24h.",
    ogLocale: "es_ES",
  },
};
